...
### Purpose
Return a Ward-linkage matrix, centroids, and labels using Agglomerative Clustering only (no K-Means/GMM/DBSCAN sweep).
...
| ----------- | ------------- | --------- | ---------------------------------------------- | ---------------------------- |
| `customers` | array<object> | Yes       | Same minimalist structure as full segmentation | See derivation details below |
...
| `amount_spent`  | float ≥ 0                | Yes      | Revenue in the selected time window | `SUM(order_total)`             |
| `product_types` | array<string> (≥ 1 item) | Yes      | Purchased SKUs or category slugs    | `ARRAY_AGG(DISTINCT cat_lvl1)` |

---

### No hyper-parameters

to tune. The endpoint decides the optimal k (2–10)
via Silhouette↑ / Davies-Bouldin↓.
    ...
    "benchmark": [
        {
            "algo": "agglo",
            "k": 2,
            "silhouette": 0.7077199816703796,
            "davies_bouldin": 0.4514254286596703
        },
        {
            "algo": "agglo",
            "k": 3,
        ...
        },
        {
            "algo": "agglo",
            "k": 7,
            "silhouette": 0.5880967378616333,
            "davies_bouldin": 0.41722555780136483
        },
        {
            "algo": "agglo",
            "k": 8,
            "silhouette": 0.5805333852767944,
            "davies_bouldin": 0.4236382619863599
        },
        {
            "algo": "agglo",
            "k": 9,
            "silhouette": 0.5868553519248962,
            "davies_bouldin": 0.44715188445995646
        },
        {
            "algo": "agglo",
            "k": 10,
            "silhouette": 0.5709341764450073,
            "davies_bouldin": 0.4166849713218054
        }
    ],
    "best_model": {
        "algo": "agglo",
...
Only Agglomerative entries appear.
...
🏆 In the sample, k = 2 wins with Silhouette = 0.708
...
Values are rescaled back to original units.
...
Dictionary:
`customer_id → cluster_id` (0-based)

🔁 Join to your CDP or feed into /segmentation_report_json_i18n

### dendrogram

| Sub-Key            | What It Is                                                  | How to Use                                                |
| ------------------ | ----------------------------------------------------------- | --------------------------------------------------------- |
| `linkage_matrix`   | SciPy-style `[child1, child2, distance, sample_count]` rows | Use with `scipy.cluster.hierarchy.dendrogram()` or Plotly |
| `leaf_labels[]`    | Customer IDs in leaf order                                  | Use as hover labels                                       |
| `cluster_legend[]` | Stats per cluster (n, spend, freq, top categories)          | Display in tooltips or side panels                        |
...
### Commercial Interpretation of the Demo Result
...
### Why Use This Endpoint vs `/purchasing_segmentation`

| Aspect          | Dendrogram Endpoint                      | Full Segmentation                           |
| --------------- | ---------------------------------------- | ------------------------------------------- |
| **Algorithms**  | Agglomerative only                       | All four families                           |
| **k Selection** | Auto-scans `k = 2...10`                  | User-defined `k_range`                      |
| **Personas**    | Not included                             | EN / ES / PT marketing narratives           |
| **Speed**       | 20–30% faster                            | Slightly slower (due to model benchmarking) |
| **Use Case**    | Visual drill-downs, exploratory analysis | Campaign-ready personas                     |

---

### Typical Workflow

POST `/purchasing_segmentation_dendrogram` → receive `linkage_matrix` + `labels`

POST `/segment_hierarchy_chart` → get `{nodes, links}` graph

Render in a React or D3 widget

Save labels to DB or call `/segmentation_report_json_i18n` for KPI export
...

{
    "nodes": [
        ...
        {
            "id": 40,
            "distance": 5.5900115966796875,
            "size": 2,
            "is_leaf": false
        },
        {
            "id":